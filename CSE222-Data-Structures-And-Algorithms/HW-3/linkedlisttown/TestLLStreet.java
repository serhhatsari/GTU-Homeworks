...
public class TestLLStreet {

    public static void testLLTown() throws Exception {
    ...
    public static void testConstructers() throws Exception {
        ...
        System.out.println("Testing the Default constructer of the LLStreet Class");
        LLStreet defaultLLStreet = new LLStreet();
        System.out.println("Default constructer of the LLStreet class has worked correctly.\n");
        ...
        System.out.println("Testing the Parameterized constructer of the LLStreet Class");
        LLStreet paramLLStreet = new LLStreet(100);
        System.out.println("Parameterized constructer of the LLStreet class has worked correctly.\n");
    ...
    public static void testEditMode() throws Exception {
        ...
        System.out.println("Lets create an LLStreet, then add all kind of buildings on it");
        LLStreet testLLStreet = new LLStreet(50);

        System.out.println("\n2.1.1: Lets add a house to the LLStreet");
        testLLStreet.addBuilding(new House(1, 10, 15, "Right", 3, "Yellow", "Yusuf", 50));
        System.out.println("\nWe added a house to the LLStreet.");
        System.out.println("Lets display the list of the buildings and skyline silhouette of the LLStreet");
        testLLStreet.printBuildingsDetails();
        testLLStreet.printLLStreet();
        System.out.println("\n\n*As it can be seen, house has been added to LLStreet.");

        System.out.println("\n2.1.2: Lets add a market to the LLStreet");
        testLLStreet.addBuilding(new Market(5, 12, 10, "Left", "09:30", "21:30", "Ahmet", 50));
        System.out.println("\nWe added a market to the LLStreet.");
        System.out.println("Lets display the list of the buildings and skyline silhouette of the LLStreet");
        testLLStreet.printBuildingsDetails();
        testLLStreet.printLLStreet();
        System.out.println("\n\n*As it can be seen, market has been added to LLStreet.");

        System.out.println("\n2.1.3: Lets add a office to the LLStreet");
        testLLStreet.addBuilding(new Office(12, 12, 7, "Right", "Software", "Akif", 50));
        System.out.println("\nWe added a office to the LLStreet.");
        System.out.println("Lets display the list of the buildings and skyline silhouette of the LLStreet");
        testLLStreet.printBuildingsDetails();
        testLLStreet.printLLStreet();
        System.out.println("\n\n*As it can be seen, office has been added to LLStreet.");

        System.out.println("\n2.1.4: Lets add a playground to the LLStreet");
        testLLStreet.addBuilding(new Playground(20, 10, 5, "Left", 50));
        System.out.println("\nWe added a playground to the LLStreet.");
        System.out.println("Lets display the list of the buildings and skyline silhouette of the LLStreet");
        testLLStreet.printBuildingsDetails();
        testLLStreet.printLLStreet();
        System.out.println("\n\n*As it can be seen, playground has been added to LLStreet.");

        System.out.println("\n\n2.2 TESTING DELETE MODE");

        System.out.println("\nLets delete some of the buildings on the LLStreet");

        System.out.println("First, lets see the list of buildings");
        testLLStreet.printBuildingPositions();
        System.out.println("\nLets delete the first building in the list\n");
        System.out.println("\nBEFORE deleting the first building:");
        testLLStreet.printLLStreet();
        System.out.println("\n\nAFTER deleting the first building:");
        testLLStreet.deleteBuilding(1);
        testLLStreet.printLLStreet();
    ...
    public static void testViewMode() throws Exception {
        ...
        System.out.println("Lets create a new LLStreet with length 50 and add some buildings on it");

        LLStreet testLLStreet = new LLStreet(50);

        testLLStreet.addBuilding(new House(10, 6, 15, "Right", 3, "Yellow", "Yusuf", 50));
        testLLStreet.addBuilding(new Market(2, 12, 10, "Left", "09:30", "21:30", "Ahmet", 50));
        testLLStreet.addBuilding(new Office(18, 12, 5, "Right", "Software", "Akif", 50));
        testLLStreet.addBuilding(new Playground(20, 10, 18, "Left", 50));

        System.out.println("\nWe add 4 buildings to the LLStreet, lets test the methods\n");

        System.out.println("\n3.1: Testing displaying the list of buildings on the LLStreet.");
        testLLStreet.printBuildingsDetails();
        System.out.println("\nAs you can see, the details of the buildings are displayed.\n");

        System.out.println("\n\n3.2: Testing displaying the number and ratio of lenth of playgrounds in the LLStreet.");
        testLLStreet.printPlaygroundInfo();
        System.out.println(
                "\nAs you can see, the the number and ratio of lenth of playgrounds in the LLStreet are displayed.\n");

        System.out.println("\n\n3.3: Testing the total length of LLStreet occupied by the markets, houses or offices.");
        testLLStreet.printTotalLengths();
        System.out.println(
                "\nAs you can see, the total length of LLStreet occupied by the markets, houses or offices are displayed.\n");

        System.out.println("\n3.4: Testing displaying the total remaining length of lands on the LLStreet.");
        testLLStreet.printRemainingLength();
        System.out.println("\nLLStreet's length was 50, considering both sides, it means 100br.");
        System.out.println(
                "We used the 40br of the LLStreet (12 br for house, 12 br for market, 10 br for playground, 6 br for house)");
        System.out.println("As you can see, remaining length is 60br.");

        System.out.println("\n\n3.5: Testing the skyline silhouette of the LLStreet.");
        testLLStreet.printLLStreet();
        System.out.println(
                "\nAs you can see, the skyline silhouette of the LLStreet İS displayed.\n");
    ...
    public static void testExceptions() throws Exception {
        ...
        System.out.println("\nLets test what happens if we try give negative value for the length of the LLStreet");
        try {
            LLStreet testLLStreet = new LLStreet(-5);
        } catch (Exception e) {
