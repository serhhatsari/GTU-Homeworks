...
public class TestArrayStreet {

    public static void testARTown() throws Exception {
                    ...
                    if (mainStreet.getNumOfBuildings() == 0) {
                        ...
                        while (check) {
                            ...
                            try {
                                ...
                                if (deleteBuildingIndex < 1
                                        || deleteBuildingIndex > mainStreet.getNumOfBuildings()) {
                                    throw new Exception();
                                }
                                ...
                                System.out
                                        .println("For example, 1: Type = House, Street Side = Left, Position = 20");
