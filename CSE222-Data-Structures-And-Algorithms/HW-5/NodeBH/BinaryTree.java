...
public class BinaryTree<E> implements Serializable {
  ...
  public BinaryTree(E data, BinaryTree<E> leftTree, BinaryTree<E> rightTree) {
    ...
    if (leftTree != null) root.left = leftTree.root; else root.left = null;
    if (rightTree != null) root.right = rightTree.root; else root.right = null;
  }
  ...
  public BinaryTree<E> getLeftSubtree() {
    if (root != null && root.left != null) return new BinaryTree<>(
      root.left
    ); else return null;
  }
  ...
  public BinaryTree<E> getRightSubtree() {
    if (root != null && root.right != null) return new BinaryTree<>(
      root.right
    ); else return null;
  }
  ...
  public static BinaryTree<String> readBinaryTree(Scanner scan) {
    ...
    if (data.equals("null")) return null; else {
  ...
  protected static class Node<E> implements Serializable {
     ...
     */
    public Node(E data, int nodeNumber, Node<E> parentNode) {
      this.data = data;
