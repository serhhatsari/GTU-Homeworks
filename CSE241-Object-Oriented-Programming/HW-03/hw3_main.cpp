...
int main()
{
    ...
    in every step of human game you can see the menu, and choose option
    if you choose computer game, you will see the menu at the end of the game
    and whenever a game has finished, game info will be printed

    you can load and save by choosing that option,
    after that you need to enter the file name you are going to load or save

    you can switch between games

    if you want to compare 2 games
    you can choose 3th option
    it will show all existing games
    you can compare the current game with the game you choose  from that list

    you can see the game info if you choose 4th option
    you will see number of pegs, number of taken pegs
    number of emptys and number of pegs in all games
